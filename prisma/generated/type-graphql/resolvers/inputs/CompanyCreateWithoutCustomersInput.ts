...
import { ProductCreateManyWithoutCompanyInput } from "../inputs/ProductCreateManyWithoutCompanyInput";
...
export class CompanyCreateWithoutCustomersInput {
  ...
  @TypeGraphQL.Field(_type => ProductCreateManyWithoutCompanyInput, {
    nullable: true,
    description: undefined
  })
