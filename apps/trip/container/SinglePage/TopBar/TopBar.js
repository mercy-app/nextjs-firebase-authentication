...
import {
  ...
  LinkedInShare,
  PinterestShare,
} from '@tripApp/components/SocialShare/SocialShare';
import Button from '@tripApp/components/UI/Antd/Button/Button';
import Menu from '@tripApp/components/UI/Antd/Menu/Menu';
import Dropdown from '@tripApp/components/UI/Antd/Dropdown/Dropdown';
import Favorite from '@tripApp/components/UI/Favorite/Favorite';
import ScrollBar from '@tripApp/components/UI/ScrollBar/ScrollBar';
